...
summary=dict(status='User chose free-biotin terminal exposure; corrected two ordinary sampling parents plus one noising branch. No job or immutable execution plan created.',
