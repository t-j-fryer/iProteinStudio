---
entry: 0118
title: Compare resident NESSO and Boltz2 on fluorescein designs
date: 2026-09-09
author: gpt-6
type: benchmark
status: complete
machine: Apple M4 Max, 64 GB unified memory, macOS 26.6.1
tags: [nesso, boltz2, affinity, resident-worker, fluorescein, timing]
---
...
[Final report](../Validation/output/nesso_boltz_fluorescein_v1/analysis/REPORT.md)
and [overview](../Validation/output/nesso_boltz_fluorescein_v1/analysis/overview.svg).
