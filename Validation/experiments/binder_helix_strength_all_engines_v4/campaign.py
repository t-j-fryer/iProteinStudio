...
SOURCE = ROOT / "Validation/output/binder_helix_strength_all_engines_v4/source"
RUNTIME = Path(os.environ.get("NANOHUNTER_ROOT", str(Path.home() / ".iproteinstudio"))).resolve()
OUTPUT = ROOT / "Validation/output/binder_helix_strength_all_engines_v4"
PROJECT = "validation_binder_helix_strength_all_engines_v4"
