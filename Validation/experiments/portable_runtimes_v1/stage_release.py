...
selected += ['release/release_app.sh','docs/INSTALL_UNSIGNED_BETA.md','docs/CLI.md','docs/NISE.md','docs/PORTABLE_RUNTIME_IMPLEMENTATION.md','docs/research/DISTRIBUTION_AND_ACCELERATION_PLAN.md','docs/research/APPLE_SILICON_THROUGHPUT_PLAN.md','lab_book/0177-integrate-psichic-portable-runtimes.md','Validation/lab_book/0047-portable-runtime-qualification.md']
