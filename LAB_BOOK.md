...
|---:|---|---|---|
| 0048 | 2026-08-31 | [Harden managed installation without perturbing the resident benchmark](lab_book/0048-harden-managed-runtime-installer.md) | Source-only first slice: install locking, sleep protection, durable logs, disk preflight, complete cancellation, partial/broken states, verified resumable downloads and transactional resource staging; cold-install/build acceptance remains gated on benchmark completion |
